...
object UserTokensId {
  ...
  implicit lazy val arrayToStatement: ToStatement[Array[UserTokensId]] =
    TypoUUID.arrayToStatement.contramap(_.map(_.value))
  implicit lazy val bijection: Bijection[UserTokensId, TypoUUID] =
    Bijection[UserTokensId, TypoUUID](_.value)(UserTokensId.apply)

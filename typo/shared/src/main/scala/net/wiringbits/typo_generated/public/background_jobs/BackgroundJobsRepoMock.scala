...
class BackgroundJobsRepoMock(toRow: Function1[BackgroundJobsRowUnsaved, BackgroundJobsRow],
                             map: scala.collection.mutable.Map[/* user-picked */ UUIDCustom, BackgroundJobsRow] = scala.collection.mutable.Map.empty) extends BackgroundJobsRepo {

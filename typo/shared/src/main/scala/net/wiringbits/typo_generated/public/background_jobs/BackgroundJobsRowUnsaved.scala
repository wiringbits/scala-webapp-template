...
case class BackgroundJobsRowUnsaved(
  ...
  def toRow(errorCountDefault: => Option[Int], executeAtDefault: => /* user-picked */ InstantCustom, createdAtDefault: => /* user-picked */ InstantCustom, updatedAtDefault: => /* user-picked */ InstantCustom): BackgroundJobsRow =
    BackgroundJobsRow(

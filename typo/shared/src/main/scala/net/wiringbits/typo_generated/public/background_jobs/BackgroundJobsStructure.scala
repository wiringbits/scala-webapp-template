...
class BackgroundJobsStructure[Row](
    val prefix: Option[String],
    val extract: Row => BackgroundJobsRow,
    val merge: (Row, BackgroundJobsRow) => Row
  ...
  override val `type` = new Field[ /* user-picked */ BackgroundJobType, Row](prefix, "type", None, None)(
    x => extract(x).`type`,
    (row, value) => merge(row, extract(row).copy(`type` = value))
  )
  override val payload = new Field[TypoJsonb, Row](prefix, "payload", None, Some("jsonb"))(
    x => extract(x).payload,
    (row, value) => merge(row, extract(row).copy(payload = value))
  )
  override val status = new Field[ /* user-picked */ BackgroundJobStatus, Row](prefix, "status", None, None)(
    x => extract(x).status,
    (row, value) => merge(row, extract(row).copy(status = value))
  )
  override val statusDetails = new OptField[String, Row](prefix, "status_details", None, None)(
    x => extract(x).statusDetails,
    (row, value) => merge(row, extract(row).copy(statusDetails = value))
  )
  override val errorCount = new OptField[Int, Row](prefix, "error_count", None, Some("int4"))(
    x => extract(x).errorCount,
    (row, value) => merge(row, extract(row).copy(errorCount = value))
  )
  override val executeAt =
    new Field[ /* user-picked */ InstantCustom, Row](prefix, "execute_at", Some("text"), Some("timestamptz"))(
  ...
  override val updatedAt =
    new Field[ /* user-picked */ InstantCustom, Row](prefix, "updated_at", Some("text"), Some("timestamptz"))(
  ...
  override def copy[NewRow](
      ...
      extract: NewRow => BackgroundJobsRow,
      merge: (NewRow, BackgroundJobsRow) => NewRow
  ): BackgroundJobsStructure[NewRow] =

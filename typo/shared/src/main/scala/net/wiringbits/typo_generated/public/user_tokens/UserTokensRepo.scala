...
trait UserTokensRepo {
  ...
  def selectByIds(userTokenIds: Array[/* user-picked */ UUIDCustom])(implicit c: Connection, toStatement: ToStatement[Array[/* user-picked */ UUIDCustom]]): List[UserTokensRow]

...
class UserLogsRepoMock(
    toRow: Function1[UserLogsRowUnsaved, UserLogsRow],
    map: scala.collection.mutable.Map[ /* user-picked */ UUID, UserLogsRow] = scala.collection.mutable.Map.empty
) extends UserLogsRepo {

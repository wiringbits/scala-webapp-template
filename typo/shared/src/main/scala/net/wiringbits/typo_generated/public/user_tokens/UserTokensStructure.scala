...
class UserTokensStructure[Row](
  ...
  override val tokenType = new Field[ /* user-picked */ UserTokenType, Row](prefix, "token_type", None, None)(
  ...
  override val expiresAt =
    new Field[ /* user-picked */ InstantCustom, Row](prefix, "expires_at", Some("text"), Some("timestamptz"))(

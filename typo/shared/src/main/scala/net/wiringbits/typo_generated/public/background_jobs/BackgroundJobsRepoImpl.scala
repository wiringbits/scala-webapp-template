...
object BackgroundJobsRepoImpl extends BackgroundJobsRepo {
  override def delete(backgroundJobId: /* user-picked */ UUIDCustom)(implicit c: Connection): Boolean = {
    SQL"""delete from public.background_jobs where "background_job_id" = ${ParameterValue(backgroundJobId, null, implicitly[ToStatement[UUIDCustom]])}""".executeUpdate() > 0
  }
  ...
  override def insert(unsaved: BackgroundJobsRow)(implicit c: Connection): BackgroundJobsRow = {
    SQL"""insert into public.background_jobs("background_job_id", "type", "payload", "status", "status_details", "error_count", "execute_at", "created_at", "updated_at")
          values (${ParameterValue(unsaved.backgroundJobId, null, implicitly[ToStatement[UUIDCustom]])}::uuid, ${ParameterValue(unsaved.`type`, null, ToStatement.stringToStatement)}, ${ParameterValue(unsaved.payload, null, TypoJsonb.toStatement)}::jsonb, ${ParameterValue(unsaved.status, null, ToStatement.stringToStatement)}, ${ParameterValue(unsaved.statusDetails, null, ToStatement.optionToStatement(ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))}, ${ParameterValue(unsaved.errorCount, null, ToStatement.optionToStatement(ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))}::int4, ${ParameterValue(unsaved.executeAt, null, implicitly[ToStatement[InstantCustom]])}::timestamptz, ${ParameterValue(unsaved.createdAt, null, implicitly[ToStatement[InstantCustom]])}::timestamptz, ${ParameterValue(unsaved.updatedAt, null, implicitly[ToStatement[InstantCustom]])}::timestamptz)
  ...
  override def insert(unsaved: BackgroundJobsRowUnsaved)(implicit c: Connection): BackgroundJobsRow = {
    val namedParameters = List(
      Some((NamedParameter("background_job_id", ParameterValue(unsaved.backgroundJobId, null, implicitly[ToStatement[UUIDCustom]])), "::uuid")),
      ...
      Some((NamedParameter("status_details", ParameterValue(unsaved.statusDetails, null, ToStatement.optionToStatement(ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))), "")),
      unsaved.errorCount match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((NamedParameter("error_count", ParameterValue(value, null, ToStatement.optionToStatement(ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))), "::int4"))
      },
      unsaved.executeAt match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((NamedParameter("execute_at", ParameterValue(value, null, implicitly[ToStatement[InstantCustom]])), "::timestamptz"))
      },
      ...
      unsaved.updatedAt match {
        case Defaulted.UseDefault => None
        case Defaulted.Provided(value) => Some((NamedParameter("updated_at", ParameterValue(value, null, implicitly[ToStatement[InstantCustom]])), "::timestamptz"))
      }
    ).flatten
    val quote = '"'.toString
    if (namedParameters.isEmpty) {
      ...
      val q = s"""insert into public.background_jobs(${namedParameters.map{case (x, _) => quote + x.name + quote}.mkString(", ")})
  ...
  override def selectById(backgroundJobId: /* user-picked */ UUIDCustom)(implicit c: Connection): Option[BackgroundJobsRow] = {
    SQL"""select "background_job_id", "type", "payload", "status", "status_details", "error_count", "execute_at"::text, "created_at"::text, "updated_at"::text
          from public.background_jobs
  ...
  override def selectByIds(backgroundJobIds: Array[/* user-picked */ UUIDCustom])(implicit c: Connection, toStatement: ToStatement[Array[/* user-picked */ UUIDCustom]]): List[BackgroundJobsRow] = {
    SQL"""select "background_job_id", "type", "payload", "status", "status_details", "error_count", "execute_at"::text, "created_at"::text, "updated_at"::text
          from public.background_jobs
  ...
  override def update(row: BackgroundJobsRow)(implicit c: Connection): Boolean = {
    ...
    SQL"""update public.background_jobs
          set "type" = ${ParameterValue(row.`type`, null, ToStatement.stringToStatement)},
              ...
              "status_details" = ${ParameterValue(row.statusDetails, null, ToStatement.optionToStatement(ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
              "error_count" = ${ParameterValue(row.errorCount, null, ToStatement.optionToStatement(ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))}::int4,
              "execute_at" = ${ParameterValue(row.executeAt, null, implicitly[ToStatement[InstantCustom]])}::timestamptz,
  ...
  override def upsert(unsaved: BackgroundJobsRow)(implicit c: Connection): BackgroundJobsRow = {
    SQL"""insert into public.background_jobs("background_job_id", "type", "payload", "status", "status_details", "error_count", "execute_at", "created_at", "updated_at")
          values (
            ...
            ${ParameterValue(unsaved.statusDetails, null, ToStatement.optionToStatement(ToStatement.stringToStatement, ParameterMetaData.StringParameterMetaData))},
            ${ParameterValue(unsaved.errorCount, null, ToStatement.optionToStatement(ToStatement.intToStatement, ParameterMetaData.IntParameterMetaData))}::int4,

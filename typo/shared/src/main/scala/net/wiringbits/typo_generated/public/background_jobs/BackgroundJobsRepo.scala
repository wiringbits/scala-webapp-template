...
trait BackgroundJobsRepo {
  ...
  def selectByIds(backgroundJobIds: Array[/* user-picked */ UUIDCustom])(implicit c: Connection, toStatement: ToStatement[Array[/* user-picked */ UUIDCustom]]): List[BackgroundJobsRow]

...
object UsersController {
  ...
  private val create = endpoint.post
    ...
    .out(
      jsonBody[CreateUser.Response].example(
        CreateUser.Response(
  ...
  private val verifyEmail = endpoint.post
    ...
    .out(jsonBody[VerifyEmail.Response].example(VerifyEmail.Response()))
  ...
  private val forgotPassword = endpoint.post
    ...
    .out(jsonBody[ForgotPassword.Response].example(ForgotPassword.Response()))
  ...
  private val resetPassword = endpoint.post
    ...
    .out(
      jsonBody[ResetPassword.Response].example(
  ...
  private val sendEmailVerificationToken = endpoint.post
    ...
    .out(
      jsonBody[SendEmailVerificationToken.Response].example(
  ...
  private val getLogs = endpoint.get
    ...
    .out(
      jsonBody[GetUserLogs.Response].example(

...
object AdminEndpoints {
  ...
  val getUserLogsEndpoint
      : Endpoint[Unit, (String, UUID, String), models.ErrorResponse, AdminGetUserLogs.Response, Any] = baseEndpoint.get
  ...
  val getUsersEndpoint: Endpoint[Unit, (String, String), models.ErrorResponse, AdminGetUsers.Response, Any] =
    baseEndpoint.get
      .in("users")
      .in(adminCookie)
      .out(

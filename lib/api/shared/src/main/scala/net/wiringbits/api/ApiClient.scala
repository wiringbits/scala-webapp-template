...
class ApiClient(config: ApiClient.Config)(implicit
  ...
  private val dummyUsersId = Future.successful(UUID.fromString("887a5d77-cb5d-4d9c-b4dc-539c8aae3977"))
  ...
  private implicit val handleDummyUsersId: ServerRequest => Future[UUID] = _ => dummyUsersId
